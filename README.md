<div align="center">
 ...
 <div style="margin-top: 30px;">
  ...
  <div align="center" style="margin-top: 50px;">
    <h2 style="font-family: 'Roboto', sans-serif; font-size: 36px; font-weight: 800; color: #1a202c; margin-bottom: 30px;">Proyectos Clave</h2>
    <p style="font-family: 'Roboto', sans-serif; color: #4A5568; font-size: 18px; line-height: 1.8; max-width: 900px; margin: 0 auto; text-align: center;">
      Mis proyectos privados son esenciales para la mejora de infraestructuras tecnológicas avanzadas. Aunque muchos de ellos no son públicos, puedes acceder a una muestra de mi trabajo a través de mi <a href="https://github.com/ynvYauneEnovore" style="color: #38B2AC;">perfil de GitHub</a>. Solicita acceso a mis demos privadas o consulta los ejemplos públicos en GitHub que reflejan la misma calidad de trabajo aplicada a proyectos en producción.
    </p>
    <ul style="font-family: 'Roboto', sans-serif; color: #4A5568; font-size: 20px; line-height: 1.8; list-style: none; padding: 0; margin: 30px 0;">
      <li><strong>VerifyTrack</strong>: Solución de procesamiento de datos en tiempo real, utilizando Docker y Kubernetes en un sistema de microservicios, optimizando recursos y permitiendo escalabilidad automática para empresas del sector de telecomunicaciones.</li>
      <li><strong>SyncOptimice</strong>: Plataforma de sincronización de datos basada en microservicios, que integra CI/CD para garantizar actualizaciones automáticas y sin interrupciones en la disponibilidad del servicio.</li>
      <li><strong>MedTrack</strong>: Aplicación avanzada para la gestión de datos médicos, utilizando contenedores Docker y orquestación Kubernetes, con una infraestructura que soporta alta disponibilidad y escalabilidad automática.</li>
    </ul>
  </div>

  <div align="center" style="margin-top: 50px;">
    <h2 style="font-family: 'Roboto', sans-serif; font-size: 36px; font-weight: 800; color: #1a202c; margin-bottom: 30px;">Certificaciones y Reconocimientos</h2>
    <ul style="font-family: 'Roboto', sans-serif; color: #4A5568; font-size: 20px; line-height: 1.8; list-style: none; padding: 0; margin: 0; text-align: left; max-width: 900px; margin: 0 auto;">
      ...
      <li><strong>Top 50% Developer</strong> en <strong>StackOverflow</strong> por contribuciones en desarrollo y solución de problemas complejos.</li>
      <li><strong>Certified Docker Professional</strong> – <em>Docker, Inc.</em></li>
    </ul>
  </div>

  <div align="center" style="margin-top: 50px;">
    <h2 style="font-family: 'Roboto', sans-serif; font-size: 36px; font-weight: 800; color: #1a202c; margin-bottom: 30px;">Logros y Estadísticas</h2>
    <div style="font-family: 'Roboto', sans-serif; color: #4A5568; font-size: 20px; line-height: 1.8; text-align: left; max-width: 900px; margin: 0 auto;">
      <p><strong>+23</strong> contribuciones a proyectos Open Source en plataformas como GitHub.</p>
